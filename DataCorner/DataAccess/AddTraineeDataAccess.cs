    ...
    public async Task<bool> InsertTraineeDetails(AddTraineesDto traineeDetails)
    {
        try
        {
            using (var connection = new MySqlConnection(_connectionString))
            {
                ...
                var cmd = new MySqlCommand("InsertTraineeDetails", connection);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@Id", traineeDetails.Id);
    ...
    public async Task<bool> UpdateTraineeDetails(AddTraineesDto traineeDetails)
    {
        try
        {
            using (var connection = new MySqlConnection(_connectionString))
            {
                ...
                var cmd = new MySqlCommand("UpdateTraineeDetails", connection);
                cmd.CommandType = CommandType.StoredProcedure;
